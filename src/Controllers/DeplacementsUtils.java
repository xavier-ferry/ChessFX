...
public class DeplacementsUtils {
     ...
     */
    public static String stringToDepartDestination(Map<String, Piece> board, String deplacement, Couleur couleurJoueur) throws CustomException {
        String laPiece = "";
        ...
        if (piecesDepart.size() == 1)
            ...
            if (resDepart.size() == 1)
                ...
                throw new CustomException("Erreur - Le déplacement saisie concerne plusieurs pièces");
        }
        throw new CustomException("Erreur - Mauvais déplacement saisie");
    }
}
